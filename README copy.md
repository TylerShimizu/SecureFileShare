...
Partner 1 Name: Tyler Shimizu

Partner 1 SID: 3036903673

Partner 1 Email: tylershimizu@berkeley.edu

Partner 2 Name (if applicable): Landon Wu

Partner 2 SID (if applicable): 3037163544

Partner 2 Email (if applicable): landonwu@berkeley.edu

Also add a link to this repo below (should start with https://github.com/cs161-students/).

Link to this Github repo: https://github.com/cs161-students/fa24-proj2-capybara.git